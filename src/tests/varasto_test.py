...
# Mikä testi jää puuttumaan? varasto_test.py" Vastauksen perusteella lisätty yksi testi koskien sitä, 
# palautuuko oikea arvo, kun varastosta yritetään ottaa enemmän kuin siellä on.
...
# että tulostuksen oikeellisuuden testi puuttui. Tämän jälkeen annoin vielä kehotteen "Kyse oli siitä, 
# että tulostuksen oikeellisuus (viimeinen kohta) jäi testaamatta. Kirjoita tätä varten testi."
